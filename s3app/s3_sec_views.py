...
from .s3_sec_models import S3Access, S3Group, S3Endpoint, S3Provider
from flask_appbuilder.models.sqla.interface import SQLAInterface

from flask_babel import lazy_gettext


class S3ProviderModelView(ModelView):
    route_base = '/s3provider'
    datamodel = SQLAInterface(S3Provider)
    list_columns = [
        'name',
